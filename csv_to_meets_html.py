...
<nav>
  <ul>
    ...
    <li><a href="#gallery" aria-label="View the Gallery">Gallery</a></li>
  </ul>
</nav>
   <header>
      <!--Meet Info-->
...
"""
        ...
        html_content += """
                                ...
                                <p>
                                    ...
                                    <address>2552 North Maple Road, Ann Arbor, MI 48103</address>
                                    <a href="https://sites.google.com/aaps.k12.mi.us/skylinecrosscountry2021/home" aria-label="Visit the XC Skyline Page">XC Skyline Page</a>
                                    <br>
